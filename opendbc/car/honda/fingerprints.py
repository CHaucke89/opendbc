...
from opendbc.cloudypilot.car.fingerprints_ext import merge_fw_versions
from opendbc.cloudypilot.car.honda.fingerprints_ext import FW_VERSIONS_EXT
...
FW_VERSIONS = {
  ...
  CAR.HONDA_HRV_3G: {
    ...
    (Ecu.transmission, 0x18da1ef1, None): [
      ...
      b'28101-6JH-M110\x00\x00',
    ],
    (Ecu.electricBrakeBooster, 0x18da2bf1, None): [
      b'39494-3L4-P030\x00\x00',
