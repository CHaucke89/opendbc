# **How custom longitudinal tuning works for Hyundai/Kia/Genesis vehicles in cloudypilot.**

This document explains the custom longitudinal control tuning implemented in cloudypilot for Hyundai, Kia, and Genesis vehicles.
